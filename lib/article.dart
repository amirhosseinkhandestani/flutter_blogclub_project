  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: Container(
        ...
        child: InkWell(
          onTap: () {
            showSnackBar(context, 'Like buttom is clicke');
          },
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Assets.img.icons.thumbsUp.image(),
              const SizedBox(
                width: 8,
              ),
              Text(
              ...
              SliverList(
                delegate: SliverChildListDelegate.fixed([
                  Padding(
                    ...
                    child: Text(
                      'Four Things Eery Woman Needs To Know',
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            showSnackBar(context, 'Share butten is clicked');
                          },
                        ...
                        IconButton(
                          onPressed: () {
                            showSnackBar(context, 'Bookmark butten is clicked');
                          },
